...
function App() {
  ...
  const [chatMobileNo, setChatMobileNo] = useState("");
  ...
  const addNewJoiner = ({ loginUserName, loginMobileNo }) => {
    if(socketConnected){
      toast.success(`Hello ${loginUserName}, you are now connected to socket...`);
      socket.connect();
      socket.emit("create", { userMobileNo: loginMobileNo, userName: loginUserName });
      setUserLogin(true);
  ...
  const sendMessageToServer = ({ loginMobileNo, chatMobileNo, messageText }) => {
    socket.emit("message", { loginMobileNo, chatMobileNo, messageText });
    setMessageText("");
  };
                    ...
                    return user.userMobileNo !== loginMobileNo ? (
                      <div
                        ...
                        style={{
                          ...
                          cursor: "pointer",
                          background:
                            user.userMobileNo === chatMobileNo ? "#f0f2f5" : "#fff",
                        }}
                        onClick={() => {
                          setChatUserName(user.userName);
                          setChatMobileNo(user.userMobileNo);
                        }}
                      >
                        <div
                          style={{
